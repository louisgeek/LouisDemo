...
import com.louis.mynavi.databinding.FragmentDeviceManagerBinding;
...
public class DeviceManagerFragment extends Fragment {
     ...
     * @return A new instance of fragment DeviceAddFragment.
     */
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.btnNext.setOnClickListener(v -> {
            PageNavigator.getInstance().markNodeCompleted(DeviceManagerFragment.class);
