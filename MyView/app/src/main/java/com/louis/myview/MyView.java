...
public class MyView extends View {
    ...
    private void initPaint() {
        ...
        mPaint.setARGB(255, 127, 255, 212);//设置透明度和颜色，a 代表透明度，r，g，b 代表颜色值
        mPaint.setStrokeWidth(10);//当画笔样式为 STROKE 或 FILL_OR_STROKE 时，设置笔刷的粗细度
        ...
        mPaint.setAlpha(50); //设置透明度，alpha 为透明度,取值范围为 0~255,数值越小越透明
        mPaint.setAntiAlias(true); //设置是否使用抗锯齿功能，较耗资源，减慢绘制速度
        mPaint.setDither(true);// 设定是否使用图像抖动，如 true，绘制出来的图片颜色更饱满、清晰
        /*
        ...
        //mPaint.setStrokeCap(Paint.Cap.BUTT);//当画笔样式为STROKE或FILL_AND_STROKE时，设置笔刷的图形样式，如圆形样式  Cap.ROUND,或方形样式 Cap.SQUARE
    ...
    protected void onDraw(@NonNull Canvas canvas) {
        ...
        /* 按照指定点的坐标绘制文本*/
        mPaint.setColor(Color.DKGRAY);
        canvas.drawTextRun("qwer", 1, 2, 3, 4, 5, 6, false, mPaint);
